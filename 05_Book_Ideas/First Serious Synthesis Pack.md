...
Corpus size analyzed: **993 videos**
...
Across the full 993-video corpus, four things stand out most clearly:
...
- **Agent architecture + coding systems** dominate the corpus (`Agent Architecture`: 374, `Coding Agents`: 465).
