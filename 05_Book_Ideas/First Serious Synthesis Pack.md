...
- **Agent architecture + coding systems** dominate the corpus (`Agent Architecture`: 400, `Coding Agents`: 492).
- **Reliability and evals** are now too large to be a chapter footnote (`Evals & Reliability`: 435).
- **Org design and leadership** remains a major recurring signal (`Org Design & Leadership`: 241).
- **Runtime/tooling/context infrastructure** is substantial and growing (`MCP & Tooling`: 126, `RAG & Retrieval`: 167).
