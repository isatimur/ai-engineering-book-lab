...
Corpus size analyzed: **1052 videos**
Transcript status mix: **{'auto_en': 2, 'auto_en_orig': 1044, 'unavailable': 5, 'whisper_base_en': 1}**
...
Across the full 1052-video corpus, four things stand out most clearly:
...
- **Agent architecture + coding systems** dominate the corpus (`Agent Architecture`: 434, `Coding Agents`: 525).
- **Reliability and evals** are now too large to be a chapter footnote (`Evals & Reliability`: 461).
- **Org design and leadership** remains a major recurring signal (`Org Design & Leadership`: 244).
