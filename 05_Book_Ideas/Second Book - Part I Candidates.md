...
> This is the raw theme-filtered list (all 129 `Models & Inference`-tagged notes) pending a hand-curation pass down to the strongest 40-60, per the design spec (`docs/superpowers/specs/2026-07-27-second-book-design.md`).
