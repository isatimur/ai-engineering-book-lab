...
3. **Code is the best domain to scale RL, because its rewards are automatically verifiable.** Unit tests and compilers give a cheap, honest reward signal that most domains lack (#251).
