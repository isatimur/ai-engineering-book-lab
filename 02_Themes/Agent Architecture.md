...
- Most common adjacent themes: Coding Agents (409), Evals & Reliability (351), MCP & Tooling (71).
...
- [[1131-cI7zfqusmFU-every-step-you-take-every-call-you-make-the-reliable-agent-stack-giselle-van-dongen-restat|#1131 — Every step you take, every call you make: the reliable agent stack — Giselle van Dongen, Restate]]
- [[1132-4lXks428C9o-we-let-an-ai-agent-execute-bash-and-lived-to-talk-about-it-sarah-sanders-posthog|#1132 — We let an AI agent execute Bash and lived to talk about it — Sarah Sanders, PostHog]]
- [[1134-9dYcwOkpCE8-how-we-solved-agent-building-andrew-qu-vercel|#1134 — How We Solved Agent Building — Andrew Qu, Vercel]]
- [[1135-fjF8EKnxKCU-agents-without-code-skills-yaml-and-filesystems-replaced-python-philipp-schmid-google-deep|#1135 — Agents Without Code: Skills, YAML, and Filesystems Replaced Python — Philipp Schmid, Google DeepMind]]
