...
summary: "Generated Code? — Harshil Agrawal shares a practical take on Why, and how you need to sandbox AI. We are using AI to write code. Key angle: focuses on agent design and orchestration; keeps returning to production-grade engineering."
---
# Why, and how you need to sandbox AI-Generated Code? — Harshil Agrawal, Cloudflare

## Summary
Generated Code? — Harshil Agrawal shares a practical take on Why, and how you need to sandbox AI. We are using AI to write code. Key angle: focuses on agent design and orchestration; keeps returning to production-grade engineering.
