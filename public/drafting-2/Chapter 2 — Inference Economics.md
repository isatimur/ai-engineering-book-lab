...
New silicon is one front. Sunny Madra of Groq frames his company's specialized inference chip against a historical marker: "just 25 years ago we crossed the 1 gigahertz speed barrier in microprocessors." (Sunny Madra, Groq) The analogy is deliberate. A step change in raw inference speed does not just make existing products faster; it unlocks applications that were impossible at the old speed, the way the gigahertz threshold once did. Purpose-built inference hardware is a bet that the GPU is not the last word on the substrate.
