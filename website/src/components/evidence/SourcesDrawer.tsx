        ...
        <>
          ...
          >
            ...
            <div className="flex-1 overflow-y-auto p-6 space-y-8">
              ...
              <Suspense
                fallback={
                  <div className="h-[360px] border border-[var(--color-border)] bg-[#F8F6F0] flex items-center justify-center font-mono text-[10px] uppercase tracking-widest text-[var(--color-ink-muted)]">
                    Loading graph…
                  </div>
                }
              >
